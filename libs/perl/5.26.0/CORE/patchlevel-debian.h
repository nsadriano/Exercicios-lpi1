	...
	,"DEBPKG:debian/patchlevel - https://bugs.debian.org/567489 List packaged patches for 5.26.0-8ubuntu1.1 in patchlevel.h"
	...
	,"DEBPKG:fixes/CVE-2018-6798-2.patch - 5.26.1: fix TRIE_READ_CHAR and DECL_TRIE_TYPE to account for non-utf8 target"
	,"DEBPKG:fixes/CVE-2018-6798-3.patch - (perl #132063) we should no longer warn for this code"
	,"DEBPKG:fixes/CVE-2018-6798-4.patch - utf8.c: Don't dump malformation past first NUL"
