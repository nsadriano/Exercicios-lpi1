...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 26 } }
...
unless (defined &__GNUC__) { sub __GNUC__() { 7 } }

unless (defined &__GNU_LIBRARY__) { sub __GNU_LIBRARY__() { 6 } }

unless (defined &__GXX_ABI_VERSION) { sub __GXX_ABI_VERSION() { 1011 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"7\.2\.0\"" } }
